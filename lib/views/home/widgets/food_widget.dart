...
class FoodWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap,
      child: Padding(padding: EdgeInsets.only(right: 25.w),
        child: Container(
          width: width * .75,
          height: 180.h,
          ...
          child: ListView(
            ...
            children: [
              Padding(padding: EdgeInsets.all(8.w), child: ClipRRect(
                borderRadius: BorderRadius.circular(12.r),
                child: SizedBox(
                  height: 112.h,
                  width: width * 0.8,
              ...
              Padding(padding: EdgeInsets.symmetric(horizontal: 12.w),child: Column(
